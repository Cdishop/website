...
\myname{Dishop}{Christopher\bibnamedelima R}
...
% Change the colours if you want
 \definecolor{SwishLineColour}{HTML}{00cc00}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Christopher R Dishop}
  
  \makefield{\faEnvelopeO}{\texttt{dishopch@msu.edu}}
  %\makefield{\faTwitter}{\texttt{}}

  \makefield{\faGlobe}{\texttt{www.christopherdishop.com}}

  \makefield{\faGithub}{\texttt{Cdishop}}
