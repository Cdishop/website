...
Now simulate the states across time (20 time points) according to the simulation set-up above. Alpha will be set to 0.7 for both states and beta will be set to 0.5. The forcing terms for goons and dirtiness will be, respectively, 25 and 20. 
