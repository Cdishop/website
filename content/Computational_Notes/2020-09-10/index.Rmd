...
The Schelling model that I created in my last post used matrix operations. It required me to think in terms of patches housed in a matrix. Consider the following 3x3 grid.
...
gp <- ggplot(patch_df, aes(x = xcoord, y = ycoord, fill = type)) + 
  geom_tile() + 
...
ggplot(plotfirst, aes(x = xcoord, y = ycoord, fill = type)) + 
  geom_tile() +
  ggtitle("Period = 0")
