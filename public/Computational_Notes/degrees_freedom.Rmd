---
title: "Degrees of Freedom are Confusing"
output: pdf_document
date: '2019-05-01'
---
...
\begin{equation}
\textremove{DF} = \textrm{Knowns} - \textrm{Unknowns}
\end{equation}

\begin{equation}
\textremove{DF} = \textrm{Unique information} - \textrm{Used information}
\end{equation}

\begin{equation}
\textremove{DF} = \textrm{Unique information in observed data} - \textrm{Information we want to pull from our data}
\end{equation}

\begin{equation}
\textremove{DF} = \textrm{Stuff in the correlation matrix} - \textrm{Stuff we want to use the correlation matrix for}
\end{equation}

\begin{equation}
\textremove{DF} = \textrm{Unique entries in the variance/covariance matrix} - \textrm{Estimated parameters}
\end{equation}
...
When you estimate an additional paramter you lose a degree of freedom. When you constrain things, you gain degrees of freedom. So, the second example has more degrees of freedom, even though it feels like we're not as "free" to draw our lines. Tricky.
